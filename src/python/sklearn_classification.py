...
if __name__ == '__main__':
    ...
    #banlanced_ratio = 5
    #banlanced_binary_processing(train_x_matrix, train_y_vector, banlanced_ratio)
    ...
    accuracy, predict_y, predict_y_proba, train_time, test_time = run_libsvm(train_x_matrix, train_y_vector, test_x_matrix, test_y_vector, logger, True, save_file)

    sdfs

    model = svm_load_model(save_file)
    predict_y, predict_acc, predict_val = svm_predict(test_y_vector.tolist(), test_x_matrix.tolist(), model, '-b 1')
    ...
    sdf
    accuracy, predict_y, predict_y_proba, train_time, test_time = run_svm_svc(train_x_matrix, train_y_vector, test_x_matrix, test_y_vector)
    ...
    #a, b = predict_matrix_with_proba_to_predict_accuracy(distance_matrix, -distance_matrix, test_y_vector)
    #print a
    #print b
