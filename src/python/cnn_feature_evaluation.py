...
def cnn_feature_evaluation_main(data_file_keyword="train_0", parameter_file="../../parameters/cnn_feature_generation.txt", class_id=-1):
    data_keyword = 'dsa'
    #data_keyword = 'rar'
    #data_keyword = 'arc'
    #data_keyword = 'ara'
    ...
    #feature_folder = "../../object/" + data_keyword + "/all_feature_classification/fcn_obj_folder/"
    feature_folder = "../../object/" + data_keyword + "/all_feature_classification/cnn_obj_folder/"
    if data_keyword == 'ara' or data_keyword == 'fixed_arc':
    ...
    log_folder = "../../log/"+data_keyword+"/cnn_feature_evaluation/"
    ...
    method = "lda"
    #method = "cpca"
    run_cnn_projected_feature_analysis(feature_folder, class_id, data_folder, data_file_keyword, method, log_folder)

if __name__ == '__main__':
    main_train_x_matrix = np.random.rand(4, 2, 1)
    print main_train_x_matrix.shape
    #
    main_train_y_vector = np.array([1, 1, 0, 0]).astype(int)
    predict = True
    map_attr_imp_matrix, run_time = project_cnn_feature_combined_rf_lda_analysis(main_train_x_matrix, main_train_y_vector)
    print run_time
    print map_attr_imp_matrix
    print map_attr_imp_analysis(map_attr_imp_matrix)
    sdfds
    argv_array = sys.argv
    ...
    cnn_feature_evaluation_main(file_keyword)
